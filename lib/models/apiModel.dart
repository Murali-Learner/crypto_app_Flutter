...
List<CoinApiModel> coinApiModelFromMap(String str) => List<CoinApiModel>.from(
    json.decode(str).map((x) => CoinApiModel.fromMap(x)));

String coinApiModelToMap(List<CoinApiModel> data) =>
...
class CoinApiModel {
  ...
  factory CoinApiModel.fromMap(Map<String, dynamic> json) => CoinApiModel(
        id: json["id"],
        symbol: json["symbol"],
        name: json["name"],
        image: json["image"],
